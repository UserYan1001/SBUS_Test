                                          ...
                                          void *phost)
{
  ...
  printf(" ///   USBH_HID_InterfaceInit %d   %d   ///  ", pphost->device_prop.Itf_Desc[0].bInterfaceSubClass, pphost->device_prop.Itf_Desc[0].bInterfaceProtocol);
  if (pphost->device_prop.Itf_Desc[0].bInterfaceSubClass == HID_BOOT_CODE)
  {
    ...
    maxEP = ((pphost->device_prop.Itf_Desc[0].bNumEndpoints <= USBH_MAX_NUM_ENDPOINTS) ? pphost->device_prop.Itf_Desc[0].bNumEndpoints : USBH_MAX_NUM_ENDPOINTS);
  ...
  else if (pphost->device_prop.Itf_Desc[0].bInterfaceSubClass == 0X00 || pphost->device_prop.Itf_Desc[0].bInterfaceSubClass == 93) // 自定义HID设备
  {
    // 自定义协议,支持游戏手柄
    if (pphost->device_prop.Itf_Desc[0].bInterfaceProtocol == 0X00 || pphost->device_prop.Itf_Desc[0].bInterfaceProtocol == 1)
    {
